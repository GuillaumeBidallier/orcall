...
import { Building, User, CheckCircle, ArrowRight, ArrowLeft } from "lucide-react";
...
export default function InscriptionPage() {
    ...
    const initialTab = searchParams.get("tab") === "professionnel" ? "professionnel" : "entreprise";
    const [activeTab, setActiveTab] = useState<"entreprise" | "professionnel">(initialTab);
    ...
    // Calcul du progrès
    const currentSteps = activeTab === "entreprise" ? steps.entreprise : steps.professionnel;
    ...
    const onEntrepriseSubmit: SubmitHandler<EntrepriseFormInputs> = async (data) => {
    ...
    const onProfessionnelSubmit: SubmitHandler<ProfessionnelFormInputs> = async (data) => {
        setIsSubmitting(true);
        try {
            const response = await registerUser(data);
            if (!response.ok) {
    ...
    const nextStep = async () => {
        const form = activeTab === "entreprise" ? entrepriseForm : professionnelForm;
        ...
        if (currentStepId === "metier") {
            ...
            valid = await form.trigger(["address", "city", "zipCode", "department", "country"]);
        ...
        <div className="container px-4 py-8 md:py-16 mx-auto">
            <div className="max-w-3xl mx-auto mb-6 md:mb-10 text-center">
                ...
                <p className="text-base md:text-xl text-gray-600">
                    Rejoignez Orcall et connectez-vous avec des professionnels du bâtiment ou trouvez de nouveaux clients.
                </p>
            </div>
            ...
            {isSuccess ? (
                <Card className="max-w-3xl mx-auto">
                    <CardContent className="pt-6 text-center">
                        ...
                        <CardTitle className="text-2xl font-bold mb-2">Inscription réussie !</CardTitle>
                ...
                >
                    <TabsList className="grid w-full grid-cols-2 mb-6 md:mb-8">
                        <TabsTrigger value="entreprise" className="flex items-center gap-2 py-3">
                            <Building className="w-5 h-5" />
                            <span>Entreprise</span>
                        </TabsTrigger>
                        <TabsTrigger value="professionnel" className="flex items-center gap-2 py-3">
                  ...
                  <span className="text-sm font-medium text-orange-500">
                    Étape {currentStep + 1} sur {currentSteps.length}: {currentSteps[currentStep].title}
                  </span>
                                </div>
                            ) : (
                    ...
                    <TabsContent value="entreprise">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Créez votre compte Entreprise pour accéder à notre réseau de professionnels qualifiés.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Form {...entrepriseForm}>
                                    <form onSubmit={entrepriseForm.handleSubmit(onEntrepriseSubmit)} className="space-y-6">
                    ...
                    <TabsContent value="professionnel">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Créez votre compte Professionnel Indépendant pour trouver des missions et développer votre activité.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Form {...professionnelForm}>
                                    <form onSubmit={professionnelForm.handleSubmit(onProfessionnelSubmit)} className="space-y-6">
